...
PRIVACY_TEXT = (
    ...
    "Для прогноза сохраняются сверенный остаток и планы по датам; для добровольного обзора — расписание и статус доставки. "
    "Также сохраняются отметки о показанных инструкциях, чтобы не повторять их при каждом входе. "
...
def welcome_text(*, family_budget: bool = False) -> str:
    ...
    return (
        ...
        "🧭 «Планы» — платежи, накопления и прогноз.\n"
        "ℹ️ Инструкции — рядом с разделом и в «Настройки и помощь».\n\n"
